...
*** Make Text mode the default mode for new buffers
    ...
    #+end_src
*** Agenda files
    Path to agenda-files needs to be machine specific. Therefore, it should be in ~"~/spacemacs/.emacs.d/init.el"~ as
    #+begin_example
      (setq org-agenda-file (list "path/to/orgfile1.org"
                                  "path/to/orgfile2.org"))
    #+end_example
** Babel
